...
Control the Hue Lamp of Phillsp through the analyzed EEG.
1. On/Off control
                ...
                if (self.slice_check[0] == 1):
                    if (self.before[count-1] == 1) :
                        ...
                        if self.result[1] == 0 :
                            ...
                            print('ttttt',self.result[0])
                            self.result[1] = self.result[0]
                            print('kkkkk',self.result[1])
                            
                            url = "http://128.134.65.120:7579/Mobius/kwu-hub/Hue-Lamp/Power"
                            ...
                            url = "http://128.134.65.120:7579/Mobius/kwu-hub/Hue-Lamp/Brightness"
                            ...
                            if self.result[0] == 3:
                                ...
                                url = "http://128.134.65.120:7579/Mobius/kwu-hub/Hue-Lamp/Color"
                                payload = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<m2m:cin xmlns:m2m=\"http://www.onem2m.org/xml/protocols\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">\n    <con>"\
