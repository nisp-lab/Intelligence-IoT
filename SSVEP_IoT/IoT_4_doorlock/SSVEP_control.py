...
Control the opening and closing of doorlock through the analyzed EEG.

Using the SVM classifier, classify and then send the results to door locks to control opening and closing.
...
class process():
    ...
    def __init__(self, stack,stim,check,time,sample_count,slice_check):
        ...
        self.url = "http://128.134.65.120:7579/Mobius/kwu-hub/Lockitron/Power"
        self.headers = {
